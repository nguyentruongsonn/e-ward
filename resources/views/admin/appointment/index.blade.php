            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3><i class="fa fa-calendar"></i> Danh sách lịch hẹn</h3>
                    </header>
                    <div class="panel-body">
                        <!-- Filter form -->
                        <div class="row" style="margin-bottom: 20px;">
                            <form method="GET" action="{{ route('admin.appointment.index') }}" class="form-inline">
                                ...
                                <div class="form-group" style="margin-right: 10px; margin-bottom: 10px;">
                                    <label for="from_date" style="margin-right: 5px; font-weight: normal;">Từ ngày:</label>
                                    <input type="date" name="from_date" id="from_date" class="form-control" 
                                           value="{{ request('from_date') }}" style="width: 150px;">
                                </div>
                                <div class="form-group" style="margin-right: 10px; margin-bottom: 10px;">
                                    <label for="to_date" style="margin-right: 5px; font-weight: normal;">Đến ngày:</label>
                                ...
                                <a href="{{ route('admin.appointment.index') }}" class="btn btn-default" style="margin-bottom: 10px;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    <tr style="background-color: {{ $isWithin24Hours ? '#bc5d37' : '#ffffff' }}; color: {{ $isWithin24Hours ? '#ffffff' : 'inherit' }};">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="{{ in_array($user->vaiTro, ['Cán bộ một cửa', 'Quản trị viên']) ? '11' : '10' }}" class="text-center">Không có lịch hẹn nào</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
