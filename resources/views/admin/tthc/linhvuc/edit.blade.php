            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3><i class="fa fa-edit"></i> Sửa Lĩnh vực</h3>
                    </header>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ route('admin.tthc.linhvuc.update', $linhVuc->maLinhVuc) }}">
                            @csrf
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tenLinhVuc" name="tenLinhVuc" 
                                       value="{{ old('tenLinhVuc', $linhVuc->tenLinhVuc) }}" required maxlength="500">
