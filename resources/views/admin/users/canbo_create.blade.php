            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3><i class="fa fa-user-plus"></i> Thêm Cán bộ</h3>
                    </header>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('admin.users.canbo.store') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select name="vaiTro" class="form-control" required>
                                        <option value="Cán bộ một cửa" {{ old('vaiTro') == 'Cán bộ một cửa' ? 'selected' : '' }}>Cán bộ một cửa</option>
                                        <option value="Cán bộ thụ lý" {{ old('vaiTro') == 'Cán bộ thụ lý' ? 'selected' : '' }}>Cán bộ thụ lý</option>
                                    </select>
                                </div>
                            </div>
