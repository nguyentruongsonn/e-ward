    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card shadow-lg border-0 wow fadeInUp" data-wow-delay="0.3s" style="border-radius: 25px;">
                <div class="row g-0">
                    <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center bg-primary text-white p-4" style="border-top-left-radius: 25px;border-bottom-left-radius:25px;">
                            ...
                            <form action="{{ route('register.submit') }}" method="POST" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="hovaten" id="hovaten" class="form-control border border-primary" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-primary"><i class="fa fa-id-card text-white"></i></span>
                                        <input type="text" name="cccd" id="cccd" class="form-control border border-primary " required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="email" id="emaill" class="form-control border border-primary " required>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="passwordd" type="password" name="password" class="form-control border border-primary" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-primary"><i class="fa fa-lock text-white"></i></span>
                                            <input id="password_confirmation" type="password" name="password_confirmation" class="form-control border border-primary" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-primary"><i class="fa fa-phone text-white"></i></span>
                                        <input id="phone" type="text" name="phone" class="form-control border border-primary" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="quequan" type="text" name="quequan"  class="form-control border border-primary" required>
                                    <span id="tbquequan"></span>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Nơi thường trú</label>
                                    <input type="text" name="thuongtru" id="thuongtru" class="form-control border border-primary" required>
                                    <span id="tbthuongtru"></span>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Nơi tạm trú</label>
                                    <input type="text" name="tamtru" id="tamtru" class="form-control border border-primary" required>
                                ...
                                <div class="d-grid">
                                    <button type="submit" id="submit_register" class="btn btn-primary btn-lg">ĐĂNG KÝ</button>
                                </div>
                                <span id="tball"></span>
